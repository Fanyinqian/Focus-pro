...
var Display = function Display(_ref) {
  ...
  if (typeof text === 'string' || typeof text === 'number') {
    if (valueEnum) {
      ...
      var enumData = isProEnumMap(valueEnum) ? valueEnum.get(text) : valueEnum[text];
      var _ref2 = enumData || {},
        status = _ref2.status,
        color = _ref2.color,
        badText = _ref2.text;
      return /*#__PURE__*/_jsx(Badge, _objectSpread({
    ...
    return /*#__PURE__*/_jsx(Space, {
      ...
      children: text === null || text === void 0 ? void 0 : text.map(function (v, i) {
        if (valueEnum) {
          ...
          var _status = _enumData.status,
            _color = _enumData.color,
            _text = _enumData.text;
          return /*#__PURE__*/_jsx(Badge, _objectSpread({
            text: _text,
            color: getTagColor({
              status: _status,
