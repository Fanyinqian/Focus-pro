...
var Badges = function Badges(props) {
  ...
  var selectMode = (fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.mode) || '';
  // 二者都可以多选，区别在于tags支持用户自由输入多选选项，mutiple仅支持从已有条目选择
  var badStyle = ['mutiple', 'tags'].includes(selectMode) ? {
    lineHeight: '18px'
  } : {
    lineHeight: '20px',
    margin: '4px 0'
  ...
  var renderOption = function renderOption() {
    ...
    return Object.keys(valueEnum).map(function (key) {
      return /*#__PURE__*/_jsx(Select.Option, {
        ...
        children: /*#__PURE__*/_jsx(Display, {
          text: key,
          valueEnum: valueEnum,
          fieldProps: {
            styles: badStyle
